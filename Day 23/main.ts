...
function arithmaticMixedType(number1:number,numberString:string):number {
...
function dividingFindingReminder(divident:number,divisor:number):{qoutient:number;reminder:number}{
