...
// creat a new array 
let lengthOfEachWord = ['Karachi', 'Islamabad', 'Fasislabad', 'Abtabad'];
// use the .map() method to create a new array that contains the length of each word
let length = lengthOfEachWord.map(lengthOfEachWord => lengthOfEachWord.length);
console.log(length);
...
// call the function
let num = [1, 5, 8, 10, 15, 20];
console.log(greaterThan10(num));
// Question 96: Demonstrate how to use the .reduce() method to calculate the sum of all numbers in an array.
// calculate the sum of all numbers
let demonstrate = [5, 10, 20, 35, 40, 50, 65,];
